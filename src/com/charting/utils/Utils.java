...
import com.charting.line.impl.Square;
...
public class Utils {
	...
	public static Data generateSquareData(int size, String title, String xLabel,
			String yLabel) {
		Data data=new Data();
		data.setTitle(title);
		data.setxAxisLabel(xLabel);
	...
	public static Data generateData(int size, String title, String xLabel,
			String yLabel, Function f) {
		Data data=new Data();
		data.setTitle(title);
		data.setxAxisLabel(xLabel);
		data.setyAxisLabel(yLabel);
	...
	public static Data generateDataFromnDB(String dbUrl, String username,
			String password, String query, String[] columns, String title) {
		...
		for(Object[] result:results){
			Pair pair = new Pair();
			pair.setX((double)result[0]);
			pair.setY((double)result[1]);
			data.add(pair);
		}
		return data;
	}
